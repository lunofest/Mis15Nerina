...
function updateTimer() {
  const targetDate = new Date("february 2, 2025 18:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '541156576358'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '541156684441'; // Número para el primer botón
  const recipientNumber2 = '541156576358'; // Número para el segundo botón
